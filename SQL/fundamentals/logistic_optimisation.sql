...
-- You have reached a conclusion that you waste to much time because you have to many different 
-- warehouse to visit each week.
...
SELECT COUNT(name) as count_products_types, producer FROM products 
GROUP BY producer ORDER BY count(producer) DESC, producer ASC